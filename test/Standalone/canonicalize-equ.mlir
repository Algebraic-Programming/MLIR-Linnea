...
func @bar(%arg0: !linnea.matrix<#linnea.property<["fullrank"]>, [30, 35], f32>, 
  ...
  %0 = linnea.equation {
    %6 = linnea.mul %arg0, %arg1, %arg2, %arg3, 
                    %arg4, %arg5 : !linnea.matrix<#linnea.property<["fullrank"]>, [30, 35], f32>, 
...
func @foo(%arg0: !linnea.matrix<#linnea.property<["square", "lowerTri"]>, [30, 30], f32>,
          %arg1: !linnea.matrix<#linnea.property<["square", "lowerTri"]>, [30, 30], f32>) -> !linnea.term {
  %0 = linnea.equation {
    %1 = linnea.mul %arg0, %arg1 : !linnea.matrix<#linnea.property<["square", "lowerTri"]>, [30, 30], f32>,
