...
func @bar(%arg0 : tensor<2x2xf64, #F>, %arg1 : tensor<2x3xf64>, %arg2 : tensor<3x2xf64>) {
  // CHECK: %{{.*}} = linnea.inverse %{{.*}} : tensor<2x2xf64, #linnea.matrix<{p = ["fullrank"]}>> -> tensor<2x2xf64, #linnea.matrix<{p = ["fullrank"]}>>
  %res = linnea.inverse %arg0 : tensor<2x2xf64, #F> -> tensor<2x2xf64, #F> 
